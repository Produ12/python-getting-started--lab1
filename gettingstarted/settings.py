...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'paas-bm-lab0.onrender.com', 'lab1-python-vf8n.onrender.com'] 
...
if IS_HEROKU_APP: 
 ...
 #ALLOWED_HOSTS = ["*"] 
    ...
    ALLOWED_HOSTS = [".localhost", "127.0.0.1", "[::1]", "0.0.0.0", "[::]", "lab1-python-vf8n.onrender.com"]
